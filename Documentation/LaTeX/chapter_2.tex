...
According to , no attempt has been made to go deeply into the science of phonetics when it comes down to the local spelling of Aklanon words. Some spellings for certain words in the language have been modeled by English words to better uderstand them for analysis. This however, might not accurately reflect how these words are pronounced. In these cases, certain general linguistic descriptions are highly necessary\cite{de1968study}.
